...
public class VentanaComputador extends JPanel{
	...
	public VentanaComputador() {
		...
		pPanelForm.add(lProcesador, reg);
		this.add(pPanelForm);
		...
		reg.gridheight = 2;
		reg.weightx = 1.0;
		JTextField procesador= new JTextField((10));
		numS.setFont(new Font("Times New Roman", Font.PLAIN, 12));
		pPanelForm.add(lProcesador);
		pPanelForm.add(procesador);
		this.add(pPanelForm);
